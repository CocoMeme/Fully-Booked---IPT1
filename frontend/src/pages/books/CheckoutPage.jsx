...
const CheckoutPage = () => {
    ...
    const totalPrice = cartItems.reduce((acc, item) => acc + (item?.discountPrice ?? item.price), 0).toFixed(2);
    ...
    const onSubmit = async(data) => {
        ...
        try {
            ...
            Swal.fire({
                title: "Confirm Order",
                text: "You palce an order successfully!",
                icon: "warning",
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                                    ...
                                    <div className="text-gray-600">
                                        ...
                                        <div className='flex items-center mb-4 '>
                                            <img src="/android-chrome-512x512.png" alt="" className='size-10 mr-1'/>
                                            <h2 className='text-xl font-semibold'>FULLY BOOKED</h2>                
                                        </div> 
                                        
                                        <div className="mr-6"> 
                                            <h2 className="font-semibold text-xl text-gray-600 mb-2">Cash On Delivery</h2>
                                            <p className="text-gray-500">Total Price: <strong>₱{totalPrice}</strong> </p>
