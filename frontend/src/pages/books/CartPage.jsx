  ...
  return (
    <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl">
                                        ...
                                        <div className="ml-4 flex flex-1 flex-col">
                                            ...
                                            <div className="flex">
                                                <button  
                                                    ...
                                                    type="button" className="flex items-center font-medium text-indigo-600 hover:text-indigo-500">
        ...
        <div className="flex justify-between text-base font-medium text-gray-900">
            <p>Subtotal</p>
            <p><strong className='font-extrabold'>₱{totalPrice ? totalPrice : 0}</strong></p>
        </div>
