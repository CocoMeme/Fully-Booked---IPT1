  ...
  return (
    <section className="flex md:bg-gray-100 min-h-screen overflow-hidden">
      <aside className="hidden sm:flex sm:flex-col">
        <a
          href="/"
          className="inline-flex items-center justify-center h-20 w-20 bg-gray-800 hover:bg-gray-500 focus:bg-gray-500"
        >
      ...
      <div className="flex-grow text-gray-800">
        ...
        <main className="p-6 sm:p-10 space-y-6 bg-gray-50 min-h-screen">
          <Outlet />
        </main>
      </div>
    </section>
